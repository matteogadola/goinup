  ...
  return (
    <>
      <div className="flex mt-2 space-x-4">
        <a href="https://www.facebook.com/goinupvertical" target="_blank" className="text-gray-600">
        ...
        <a href="https://www.instagram.com/goinupvertical" target="_blank" className="text-gray-600">
